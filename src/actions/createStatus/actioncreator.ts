        ...
        general: [
            ...
            },
            {
                ...
                resultText: {
                    ...
                    left: "あなたは既存のベストプラクティスや方法を重視します。このアプローチはリスクを最小限に抑える場合に有用です。",
                    right: "あなたは独自の方法で問題解決を試みる傾向があります。このアプローチは新しいソリューションを見つける場合に有用です。"
                },
                categoryLeftPercent: "50%",
                categoryRightPercent: "50%"
            },
        ...
        designer: [
            {
                ...
                answer: null,
                resultText: {
                    neutral: "あなたは機能と形のバランスを重視しています。これはプロダクトが使いやすい一方で、魅力的な見た目も保つという理想的な中間点を目指している可能性があります。",
                    left: "あなたは機能性を最優先しています。このアプローチはユーザーの目的を効率的に達成できますが、一部のユーザーは見た目の魅力も重要と感じるかもしれません。",
                    right: "あなたは形、つまりデザインを重視しています。美しいデザインは人々を引きつけますが、機能性が犠牲になる可能性もあります。"
                },
                categoryLeftPercent: "50%",
                categoryRightPercent: "50%"
            },
            {
                ...
                answer: null,
                resultText: {
                    neutral: "あなたは芸術的な表現とユーザーのニーズのバランスを取るスタイルを持っています。これは多くの場面で広い視野を持つことができるという意味です。",
                    left: "あなたは芸術的な表現を重視しています。これは独自のスタイルを持つことができますが、一部のユーザーには理解されにくいかもしれません。",
                    right: "あなたはユーザーのニーズを重視しています。これは使い勝手の良いプロダクトを作る強みですが、創造性が少なく感じられる場合もあります。"
                },
                categoryLeftPercent: "50%",
                categoryRightPercent: "50%"
            },
            {
                ...
                answer: null,
                resultText: {
                    neutral: "あなたは詳細とシンプルさの両方に価値を見い出しています。このバランスは、多くの場合で広い視点を持つことを可能にします。",
                    left: "あなたは細部の装飾や要素を重視しています。これは視覚的に魅力的なデザインを生む可能性がありますが、使い勝手が犠牲になる場合もあるでしょう。",
                    right: "あなたはシンプルなデザインを好む傾向があります。これは使い勝手を高めますが、一部の人々には退屈に感じられるかもしれません。"
                },
                categoryLeftPercent: "50%",
                categoryRightPercent: "50%"
            },
        ...
        engineer: [
            ...
            },
            {
                ...
                resultText: {
                    ...
                    left: "あなたはCSS-in-JSの利用に傾いています。これはコンポーネントベースのアーキテクチャでスタイリングを効率的に管理する場合に有利です。",
                    right: "あなたは伝統的なスタイリング手法を好みます。このアプローチは既存のプロジェクトや広範なブラウザ対応が必要なケースで有用です。"
                },
                categoryLeftPercent: "50%",
                categoryRightPercent: "50%"
            },
